...
def admin_storage():
    ...
    for path_name, path in paths:
        ...
        #Windows - Windows doesn't have the ability to check size of file path, but can give you the total space 
        #available on the C drive. Uncomment the lines after this and comment out the previous 8 lines to use
        ...
        #    'disk_total': total,
        #    'disk_avail': free,
        #    'used': used if path_name != 'train_data' else '?'
        #})
